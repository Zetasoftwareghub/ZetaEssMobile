...
import '../providers/bussiness_gift_provider.dart';
    ...
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              8.heightBox,
              CustomDropdown(
                hintText: 'Claim settlement mode'.tr(),
                items:
                    ['Cash', 'Payroll', 'Other']
      ...
      bottomSheet: Padding(
        ...
        child: CustomElevatedButton(
          onPressed: () {
            final claimModel = SaveClaimModel(
              suconn: "ABC123",
              exmtid: 101,
              hfEmcode: 2025,
              reqDate: "2025-11-27",
              ...
              comments: "This is a test claim submission.",
              emcode: 9001,
              amtpad: 1200,
              exstype: "Travel",
              exsdisplay: "Local Travel",
              repMnth: "2025-11",
              repayCashDate: "2025-12-05",
              expDetls: [
                ClaimDetail(
                  ...
                  jobNumber: "JOB1122",
                  actualAmount: "500",
                  requiredConversionRate: "1",
                  analysisText: "Travel Expense",
                  analysisValue: "TR01",
                  detailId: "EX12345",
                ),
              ],
              ...
              attachments: [
                ClaimAttachmentModel(
                  mediaFile: "base64-encoded-string-or-file-path",
                  fileName: "receipt_1.jpg",
                ),
              ],
              baseDirectory: "/storage/emulated/0/Download/",
              extotl: 500,
              bgtotl: 1500,
              sbtotl: 2000,
              adtotl: 1000,
            ...
            ref
                ...
                .saveClaim(context: context, saveClaimModel: claimModel);
          },
                  ...
                  trailing: PopupMenuButton(
                    ...
                    onSelected: (value) {
                      if (value == 'edit') {
                        ...
                        //TODO change this to custom Alert Box
