...
import 'package:zeta_ess/features/self_service/schooling_allowance/screens/submitSchoolingAllowance_screen.dart';

import '../../../../core/common/widgets/customTileListing_widget.dart';
import '../../../../core/utils.dart';

class SchoolingAllowanceListingScreen extends StatelessWidget {
  final String title;

  const SchoolingAllowanceListingScreen({super.key, required this.title});
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            NavigationService.navigateToScreen(
              context: context,
              screen: SubmitSchoolingAllowanceScreen(),
            );
          },
      ...
      itemBuilder: (context, index) {
        return InkWell(
          onTap:
              () => NavigationService.navigateToScreen(
                context: context,
                screen: SchoolingAllowanceDetailScreen(),
              ),
