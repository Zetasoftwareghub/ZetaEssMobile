...
void showCustomAlertBox(
  ...
  Duration animationDuration = const Duration(milliseconds: 250), // Faster, more professional
  Widget? customIcon,
  Color? customColor,
  double? maxWidth,
  TextAlign textAlign = TextAlign.center,
  ...
  final iconSize = isTablet ? 32.0 : 28.0; // Slightly smaller for professional look
  ...
  final alertColor = getAlertColor();
  final alertIcon = customIcon ?? Icon(
    getAlertIcon(),
    color: alertColor,
    size: iconSize,
  );
                            ...
                            AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                return Transform.translate(
                                  offset: Offset(0, (1 - animation1.value) * 10),
                                  child: Opacity(
                                    opacity: animation1.value * 0.8, // Slightly faded
                                    child: Text(
                                      content.tr(),
                                      style: TextStyle(
...
extension AlertBoxExtension on BuildContext {
  void showSuccessAlert(String title, {String? content, VoidCallback? onConfirm}) {
    showCustomAlertBox(
      this,
      title: title,
      content: content,
  ...
  void showErrorAlert(String title, {String? content, VoidCallback? onConfirm}) {
    showCustomAlertBox(
      this,
      title: title,
      content: content,
  ...
  void showWarningAlert(String title, {String? content, VoidCallback? onConfirm}) {
    showCustomAlertBox(
      this,
      title: title,
      content: content,
