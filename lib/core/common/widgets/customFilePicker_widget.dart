...
class FileUploadButton extends ConsumerWidget {
  ...
  const FileUploadButton({super.key, this.editFileUrl});
...
// file_upload_button.dart
//
//OLD CODE  class FileUploadButton extends ConsumerWidget {
...
//   final PlatformFile? platformFile;
//
//   FileUploadState({this.base64, this.extension, this.platformFile});
// }
//
// class FileUploadNotifier extends AutoDisposeAsyncNotifier<FileUploadState> {
//   @override
...
//
//   void clearFile() {
//     state = AsyncValue.data(FileUploadState()); // Reset state
//   }
// }
